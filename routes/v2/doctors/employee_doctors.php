...
Route::prefix("employee-doctors")->group(function(){
    Route::post("all", [EmployeeController::class, "getDoctors"]);
    Route::post("show", [EmployeeController::class, "doctorDetails"]);
    ...
    Route::post("appointments", [AppointmentsController::class, "doctor_appointments"])->middleware(['permission:View Appointments']);
});
