                        ...
                        <tbody>
                            @foreach ($invoices as $invoice)
                                <tr>
                                    ...
                                    <td class="col-md-3">{{ $invoice?->total_with_vat }}</td>
                                    <td class="col-md-3">{{ $invoice?->status == 1 ? 'Paid' : 'Unpaid' }}</td>
                                    <td class="col-md-3">{{ $invoice?->created_at->format('d-m-Y') }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
