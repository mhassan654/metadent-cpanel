                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($activities as $activity)
                                <tr>
                                    {{-- <td class="col-md-3">{{ !is_null($activity?->patient) ? $activity?->patient?->first_name.' '. $activity?->patient?->last_name : '' }}</td> --}}
                ...
                <div class="row">
                    <div class="receipt-header receipt-header-mid receipt-footer">
                        <div class="col-xs-8 col-sm-8 col-md-8 text-left">
                            <div class="receipt-right">
                                <p><b>Employee Name :</b>
                                    {{ $user[0]->first_name . ' ' . $user[0]->maiden_name . ' ' . $user[0]->last_name }}
                                </p>
