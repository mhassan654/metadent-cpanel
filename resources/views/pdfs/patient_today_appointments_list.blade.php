...
<head>
    ...
    <title>Patient Today Appointments</title>
    <style>
        .text-danger strong {
            color: #FF782E;
        }
                        ...
                        <tbody>
                            @foreach ($patients as $patient)
                                <tr>
                                    ...
                                    <td class="col-md-3">{{ $patient->patient_phone }}</td>
                                    ...
                                    <td class="col-md-3">{{ $patient?->appointments[0]?->status?->status }}</td>
                                    <td class="col-md-3">{{ $patient?->appointments[0]?->slots[0]['start-time'] }} -
                                        {{ $patient?->appointments[0]?->slots[0]['end-time'] }}</td>
                                    <td class="col-md-3">{{ $patient?->appointments[0]->source?->source }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
