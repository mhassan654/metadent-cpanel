...
<head>
    ...
    <title>DoctorsWithTreatments</title>
    <style>
        .text-danger strong {
            color: #FF782E;
        }
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($employees as $doctor)
                                <tr>
                                    <td class="col-md-3">{{ $doctor?->first_name }} {{ $doctor?->middle_name }}
                                        {{ $doctor?->last_name }}</td>
                                    <td class="col-md-3">{{ $doctor?->department?->department }}</td>
                                    <td class="col-md-3">{{ '#' . '000' . $doctor->treatments[0]?->id }}</td>
                                    <td class="col-md-3">
                                    ...
                                    <td class="col-md-3">{{ $doctor?->treatments[0]?->treatment_status }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
