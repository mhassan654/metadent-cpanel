...
<head>
    ...
    <title>Invoice Transactions</title>
    <style>
        .text-danger strong {
            color: #FF782E;
        }
                        ...
                        <tbody>
                            @foreach ($transactions as $transaction)
                                <tr>
                                    ...
                                    <td class="col-md-3">{{ $transaction?->method }}</td>
                                    <td class="col-md-3">{{ $transaction?->created_at->format('jS M Y') }}</td>
                                    <td class="col-md-3">{{ $transaction?->status }} </td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                <div class="row">
                    <div class="receipt-header receipt-header-mid receipt-footer">
                        <div class="col-xs-8 col-sm-8 col-md-8 text-left">
                            <div class="receipt-right">
                                <p>Invoice Number :</b> {{ $invoice[0]->invoice_id }}</p>
