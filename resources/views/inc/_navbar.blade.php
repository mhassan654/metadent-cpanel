                ...
                <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                    ...
                    <ul class="nav navbar-nav bookmark-icons">
                        <li class="nav-item d-none d-lg-block">
                            ...
                            <a class="btn btn-sm btn-light-danger mr-1 mb-1" href="{{ route('cache.clear')}}">
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="javascript:void(0);" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none">
                                ...
                                <span class="user-status text-muted">{{Auth::guard('admin')->user()->email}}</span>
                            </div>
                            <span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right pb-0">
                            ...
                            <a class="dropdown-item" href="app-todo.html">
                                <i class="bx bx-check-square mr-50"></i> Task</a><a class="dropdown-item" href="app-chat.html">
