...
class PatientDoneTreatments implements FromCollection, withHeadings, withMapping
{
    ...
    {
        return \App\Models\DoneTreatment::with(['employees', 'invoices'])->whereIn('id', $this->treatments)->latest()->get();
    }
